...
import BoardSelect from "../CommonComponent/BoardSelect";

const IntermediateDetails = () => {
  return (
    <div className="card my-4 box-shadow2">
      <h6 className="card-header bg-2E3944 text-white">12th / Intermediate Details</h6>
      <div className="card-body">
        <form action="">
          <div className="mb-3">
            <label className="col-12">Board</label>
            <BoardSelect />
          </div>
